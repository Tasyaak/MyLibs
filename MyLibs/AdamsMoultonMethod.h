...
private:
	...
	using ReturnType = std::conditional_t<std::is_same_v<StateType, double>, double, Matrix>;
...
public:
	...
	inline AdamsMoultonMethod(StateType(*F)(double, const StateType&), double t0, double T) : F(F), t0(t0), T(T) {}
